...
int main()
{
  ...
  auto p0 = new_point2(Vector{0, -0.1, 0});
  auto p1 = new_point2(Vector{0.84, -0.1, 0});
  auto p2 = new_point2(Vector{0.84, 0.2, 0});
  auto p3 = new_point2(Vector{0.84, 0.36, 0});
  auto p4 = new_point2(Vector{0.84, 0.52, 0});
  auto p5 = new_point2(Vector{0.84, 1.1, 0});
  auto p6 = new_point2(Vector{0, 1.1, 0});
  ...
  auto r = extrude_face(f, Vector{0., 0., 0.04}).middle;
